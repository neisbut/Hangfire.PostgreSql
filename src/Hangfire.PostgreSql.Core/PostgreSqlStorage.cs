...
namespace Hangfire.PostgreSql
{
	public class PostgreSqlStorage : JobStorage
	{
		...
		public PostgreSqlStorage(string nameOrConnectionString, PostgreSqlStorageOptions options)
		{
			...
			{
				_connectionString = Configuration.GetConnectionString(nameOrConnectionString);
			}
			else
			{
		...
		{
			var connectionStringSetting = Configuration.GetConnectionString(connectionStringName);
